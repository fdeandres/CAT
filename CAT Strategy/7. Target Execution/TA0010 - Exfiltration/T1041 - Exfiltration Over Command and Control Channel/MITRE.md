<div class="container-fluid">
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      to upload files to the C2 Server.
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      <span class="scite-citeref-number" data-reference="Scarlet Mimic Jan 2016" id="scite-ref-5-a" onclick="scrollToRef('scite-5')">
       <sup>
        <a aria-describedby="qtip-4" data-hasqtip="4" href="http://researchcenter.paloaltonetworks.com/2016/01/scarlet-mimic-years-long-espionage-targets-minority-activists/" target="_blank">
         [5]
        </a>
       </sup>
      </span>
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      file stealer transfers collected files to a hardcoded C2 server.
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      <span class="scite-citeref-number" data-reference="Villeneuve et al 2014" id="scite-ref-7-a" onclick="scrollToRef('scite-7')">
       <sup>
        <a aria-describedby="qtip-6" data-hasqtip="6" href="https://www.fireeye.com/content/dam/fireeye-www/global/en/current-threats/pdfs/wp-operation-ke3chang.pdf" target="_blank">
         [7]
        </a>
       </sup>
      </span>
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      malware IndiaIndia saves information gathered about the victim to a file that is uploaded to one of its 10 C2 servers. Another
      <a href="https://attack.mitre.org/groups/G0032">
       Lazarus Group
      </a>
      malware sample also performs exfiltration over the C2 channel.
      ...
      <span class="scite-citeref-number" data-reference="Novetta Blockbuster Loaders" id="scite-ref-9-a" onclick="scrollToRef('scite-9')">
       <sup>
        <a aria-describedby="qtip-8" data-hasqtip="8" href="https://operationblockbuster.com/wp-content/uploads/2016/02/Operation-Blockbuster-Loaders-Installers-and-Uninstallers-Report.pdf" target="_blank">
         [9]
        </a>
       </sup>
      </span>
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      <span class="scite-citeref-number" data-reference="Talos ROKRAT" id="scite-ref-14-a" onclick="scrollToRef('scite-14')">
       <sup>
        <a aria-describedby="qtip-13" data-hasqtip="13" href="https://blog.talosintelligence.com/2017/04/introducing-rokrat.html" target="_blank">
         [14]
        </a>
       </sup>
      </span>
   ...
   <tr>
    ...
    <td>
     <p>
      After data is collected by
      <a href="https://attack.mitre.org/groups/G0038">
       Stealth Falcon
      </a>
      malware, it is exfiltrated over the existing C2 channel.
      <span class="scite-citeref-number" data-reference="Citizen Lab Stealth Falcon May 2016" id="scite-ref-15-a" onclick="scrollToRef('scite-15')">
       <sup>
        <a aria-describedby="qtip-14" data-hasqtip="14" href="https://citizenlab.org/2016/05/stealth-falcon/" target="_blank">
         [15]
        </a>
       </sup>
      </span>
 ...
 <p>
  ...
  <span class="scite-citeref-number" data-reference="University of Birmingham C2" id="scite-ref-16-a">
   <sup>
    <a aria-describedby="qtip-15" data-hasqtip="15" href="https://arxiv.org/ftp/arxiv/papers/1408/1408.1136.pdf" target="_blank">
     [16]
    </a>
   </sup>
  </span>
   ...
   <ol>
    ...
    <li>
     <span class="scite-citation" id="scite-5">
      <span class="scite-citation-text">
       <a class="external text" href="http://researchcenter.paloaltonetworks.com/2016/01/scarlet-mimic-years-long-espionage-targets-minority-activists/" name="scite-5" rel="nofollow" target="_blank">
    ...
    <li>
     <span class="scite-citation" id="scite-7">
      <span class="scite-citation-text">
       <a class="external text" href="https://www.fireeye.com/content/dam/fireeye-www/global/en/current-threats/pdfs/wp-operation-ke3chang.pdf" name="scite-7" rel="nofollow" target="_blank">
   ...
   <ol start="9.0">
    <li>
     <span class="scite-citation" id="scite-9">
      <span class="scite-citation-text">
       <a class="external text" href="https://operationblockbuster.com/wp-content/uploads/2016/02/Operation-Blockbuster-Loaders-Installers-and-Uninstallers-Report.pdf" name="scite-9" rel="nofollow" target="_blank">
    ...
    <li>
     <span class="scite-citation" id="scite-14">
      <span class="scite-citation-text">
       <a class="external text" href="https://blog.talosintelligence.com/2017/04/introducing-rokrat.html" name="scite-14" rel="nofollow" target="_blank">
    ...
    <li>
     <span class="scite-citation" id="scite-15">
      <span class="scite-citation-text">
       <a class="external text" href="https://citizenlab.org/2016/05/stealth-falcon/" name="scite-15" rel="nofollow" target="_blank">
    ...
    <li>
     <span class="scite-citation" id="scite-16">
      <span class="scite-citation-text">
       <a class="external text" href="https://arxiv.org/ftp/arxiv/papers/1408/1408.1136.pdf" name="scite-16" rel="nofollow" target="_blank">
