 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="SEAttackVectors" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="BeachSE2003" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   <tr>
    ...
    <td>
     <a href="https://attack.mitre.org/techniques/T1279">
      Conduct social engineering
     </a>
    </td>
   </tr>
   <tr>
    ...
    <td>
     <a href="https://attack.mitre.org/techniques/T1268">
      Conduct social engineering
     </a>
    </td>
   </tr>
