 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="Heffter" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       Clyde R. Heffter. (2011, August 4). A Fresh Look at Collection Requirements. Retrieved March 2, 2017.
      </span>
     </span>
    </li>
   </ol>
