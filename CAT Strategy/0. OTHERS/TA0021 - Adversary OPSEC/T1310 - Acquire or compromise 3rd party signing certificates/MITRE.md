 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="Adobe Code Signing Cert" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   <tr>
    ...
    <td>
     <a href="https://attack.mitre.org/techniques/T1332">
      Acquire or compromise 3rd party signing certificates
     </a>
    </td>
   </tr>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       Brad Arkin. (2012, September 27). Inappropriate Use of Adobe Code Signing Certificate. Retrieved March 28, 2017.
      </span>
     </span>
    </li>
   </ol>
