<div class="container-fluid">
 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="FakeLinkedIn" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   <tr>
    <td>
     <a href="https://attack.mitre.org/tactics/TA0020">
      Organizational Weakness Identification
     </a>
    </td>
    <td>
     <a href="https://attack.mitre.org/techniques/T1300">
      Analyze organizational skillsets and deficiencies
     </a>
    </td>
   </tr>
   <tr>
    <td>
     <a href="https://attack.mitre.org/tactics/TA0018">
      Technical Weakness Identification
     </a>
    </td>
    <td>
     <a href="https://attack.mitre.org/techniques/T1289">
      Analyze organizational skillsets and deficiencies
     </a>
    </td>
   </tr>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       LIFARS. (2015, October 8). Hackers Fake LinkedIn Profiles to Scout Targets. Retrieved March 5, 2017.
      </span>
     </span>
    </li>
   </ol>
