 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="Schneier-cloud" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="Computerworld-suppliers" id="scite-ref-3-a">
     <sup>
      [3]
     </sup>
    </span>
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   <tr>
    ...
    <td>
     <a href="https://attack.mitre.org/techniques/T1260">
      Determine 3rd party infrastructure services
     </a>
    </td>
   </tr>
