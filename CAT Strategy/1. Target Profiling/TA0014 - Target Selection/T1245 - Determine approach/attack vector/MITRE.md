 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="WITCHCOVEN2015" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="JP3-60" id="scite-ref-3-a">
     <sup>
      [3]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="JP3-12R" id="scite-ref-4-a">
     <sup>
      [4]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="DoD Cyber 2015" id="scite-ref-5-a">
     <sup>
      [5]
     </sup>
    </span>
   ...
   <ol>
    ...
    <li>
     <span class="scite-citation" id="scite-2">
      <span class="scite-citation-text">
       Jonathan Wrolstad and Barry Vengerik. (2015, November). Pinpointing Targets: Exploiting Web Analytics to Ensnare Victims. Retrieved March 5, 2017.
      </span>
     </span>
    </li>
    <li>
