 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="man traceroute" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="Shodan Tutorial" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
