<div class="container-fluid">
 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="Google Domains WHOIS" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="FunAndSun2012" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="Scasny2015" id="scite-ref-3-a">
     <sup>
      [3]
     </sup>
    </span>
 ...
 Open access to DNS registration/routing information is inherent in Internet architecture.
 <br/>
 <br/>
 ...
 Proliferation of DNS information makes registration information functionally freely available.
 <br/>
 <br/>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       Google Domains. (n.d.). About WHOIS. Retrieved April 2, 2017.
      </span>
     </span>
    </li>
    <li>
