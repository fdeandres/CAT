<div class="container-fluid">
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   <tr>
    <td>
     <a href="https://attack.mitre.org/tactics/TA0026">
      Stage Capabilities
     </a>
    </td>
    <td>
     <a href="https://attack.mitre.org/techniques/T1364">
      Friend/Follow/Connect to targets of interest
     </a>
    </td>
   </tr>
 ...
 The nature of social media is such that the adversary naturally connects to a target of interest without suspicion, given the purpose of the platform is to promote connections between individuals.  Performing activities like typical users, but with specific intent in mind.
 <br/>
 <br/>
