 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="AnonHBGary" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="Hacked Social Media Accounts" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
