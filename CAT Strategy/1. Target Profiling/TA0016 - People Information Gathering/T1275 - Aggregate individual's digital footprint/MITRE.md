 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="DigitalFootprint" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="trendmicro-vtech" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       Christopher Budd. (2016, June 27). The importance of understanding your digital footprint. Retrieved May 4, 2017.
      </span>
     </span>
    </li>
   </ol>
   ...
   <ol start="2.0">
    <li>
     <span class="scite-citation" id="scite-2">
      <span class="scite-citation-text">
       Christopher Budd. (2015, December 1). Understanding the Risks of the VTech Data Breach. Retrieved May 9, 2017.
      </span>
     </span>
    </li>
   </ol>
