<div class="container-fluid">
 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="TrendmicroHideoutsLease" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   <tr>
    ...
    <td>
     <a href="https://attack.mitre.org/techniques/T1307">
      Acquire and/or use 3rd party infrastructure services
     </a>
    </td>
   </tr>
 ...
 Hard to differentiate from standard business operations.
 <br/>
 <br/>
 ...
 Wide variety of cloud/VPS/hosting/compute/storage solutions available for adversary to acquire freely or at a low cost.
 <br/>
 <br/>
