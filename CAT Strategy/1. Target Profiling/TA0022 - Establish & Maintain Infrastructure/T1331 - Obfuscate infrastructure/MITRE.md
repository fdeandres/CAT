 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="FireEyeAPT17" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
 ...
 <table class="table table-bordered table-light mt-2">
  ...
  <tbody class="bg-white">
   <tr>
    ...
    <td>
     <a href="https://attack.mitre.org/techniques/T1309">
      Obfuscate infrastructure
     </a>
    </td>
   </tr>
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      <span class="scite-citeref-number" data-reference="FireEye APT17" id="scite-ref-2-a" onclick="scrollToRef('scite-2')">
       <sup>
        <a aria-describedby="qtip-1" data-hasqtip="1" href="https://www2.fireeye.com/rs/fireye/images/APT17_Report.pdf" target="_blank">
         [2]
        </a>
       </sup>
      </span>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       FireEye. (2015, May). APT17: Hiding in Plain Sight - FireEye and Microsoft Expose Obfuscation Tactic. Retrieved March 6, 2017.
      </span>
     </span>
    </li>
   </ol>
   ...
   <ol start="2.0">
    <li>
     <span class="scite-citation" id="scite-2">
      <span class="scite-citation-text">
       <a class="external text" href="https://www2.fireeye.com/rs/fireye/images/APT17_Report.pdf" name="scite-2" rel="nofollow" target="_blank">
