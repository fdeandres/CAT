 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="OCIAC Pre Incident Indicators" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="NewsAgencySpy" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       Orange County Intelligence Assessment Center. (n.d.). Pre-Incident Indicators. Retrieved March 28, 2017.
      </span>
     </span>
    </li>
   </ol>
   ...
   <ol start="2.0">
    <li>
     <span class="scite-citation" id="scite-2">
      <span class="scite-citation-text">
       The Canadian Press. (2012, August 22). Reporter says Chinese news agency asked him to spy. Retrieved March 9, 2017.
      </span>
     </span>
    </li>
   </ol>
