 ...
 <div class="row">
  <div class="col-md-8 description-body">
   <p>
    ...
    <span class="scite-citeref-number" data-reference="USBMalwareAttacks" id="scite-ref-1-a">
     <sup>
      [1]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="FPDefendNewDomain" id="scite-ref-2-a">
     <sup>
      [2]
     </sup>
    </span>
    <span class="scite-citeref-number" data-reference="ParkingLotUSB" id="scite-ref-3-a">
     <sup>
      [3]
     </sup>
    </span>
    ...
    <li>
     <span class="scite-citation" id="scite-1">
      <span class="scite-citation-text">
       Sean Carroll. (2010, November 4). USB Malware Attacks On the Rise. Retrieved March 9, 2017.
      </span>
     </span>
    </li>
    <li>
     <span class="scite-citation" id="scite-2">
      <span class="scite-citation-text">
       William J. Lynn III. (2010, September). Defending a New Domain. Retrieved March 9, 2017.
      </span>
     </span>
    </li>
   </ol>
   ...
   <ol start="3.5">
    <li>
     <span class="scite-citation" id="scite-3">
      <span class="scite-citation-text">
       Emil Protalinski. (2012, July 11). Criminals push malware by 'losing' USB sticks in parking lots. Retrieved March 9, 2017.
      </span>
     </span>
    </li>
   </ol>
