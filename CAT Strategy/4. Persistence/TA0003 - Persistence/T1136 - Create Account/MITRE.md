<div class="container-fluid">
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      has a module for creating a new domain user or local user if permissions allow.
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      <span class="scite-citeref-number" data-reference="Kaspersky Flame" id="scite-ref-7-a" onclick="scrollToRef('scite-7')">
       <sup>
        <a aria-describedby="qtip-6" data-hasqtip="6" href="https://securelist.com/the-flame-questions-and-answers-51/34344/" target="_blank">
         [7]
        </a>
       </sup>
      </span>
      <span class="scite-citeref-number" data-reference="Kaspersky Flame Functionality" id="scite-ref-8-a" onclick="scrollToRef('scite-8')">
       <sup>
        <a aria-describedby="qtip-7" data-hasqtip="7" href="https://securelist.com/flame-bunny-frog-munch-and-beetlejuice-2/32855/" target="_blank">
         [8]
        </a>
       </sup>
      </span>
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      <span class="scite-citeref-number" data-reference="Cylance Dust Storm" id="scite-ref-10-a" onclick="scrollToRef('scite-10')">
       <sup>
        <a aria-describedby="qtip-9" data-hasqtip="9" href="https://www.cylance.com/content/dam/cylance/pdfs/reports/Op_Dust_Storm_Report.pdf" target="_blank">
         [10]
        </a>
       </sup>
      </span>
   ...
   <tr>
    ...
    <td>
     <p>
      ...
      <span class="scite-citeref-number" data-reference="Savill 1999" id="scite-ref-11-a" onclick="scrollToRef('scite-11')">
       <sup>
        <a aria-describedby="qtip-10" data-hasqtip="10" href="http://windowsitpro.com/windows/netexe-reference" target="_blank">
         [11]
        </a>
       </sup>
      </span>
 ...
 <p>
  ...
  <span class="scite-citeref-number" data-reference="Microsoft User Creation Event" id="scite-ref-13-a">
   <sup>
    <a aria-describedby="qtip-12" data-hasqtip="12" href="https://docs.microsoft.com/windows/device-security/auditing/event-4720" target="_blank">
     [13]
    </a>
   </sup>
  </span>
   ...
   <ol>
    ...
    <li>
     <span class="scite-citation" id="scite-7">
      <span class="scite-citation-text">
       <a class="external text" href="https://securelist.com/the-flame-questions-and-answers-51/34344/" name="scite-7" rel="nofollow" target="_blank">
   ...
   <ol start="8.5">
    <li>
     <span class="scite-citation" id="scite-8">
      <span class="scite-citation-text">
       <a class="external text" href="https://securelist.com/flame-bunny-frog-munch-and-beetlejuice-2/32855/" name="scite-8" rel="nofollow" target="_blank">
    ...
    <li>
     <span class="scite-citation" id="scite-10">
      <span class="scite-citation-text">
       <a class="external text" href="https://www.cylance.com/content/dam/cylance/pdfs/reports/Op_Dust_Storm_Report.pdf" name="scite-10" rel="nofollow" target="_blank">
    ...
    <li>
     <span class="scite-citation" id="scite-11">
      <span class="scite-citation-text">
       <a class="external text" href="http://windowsitpro.com/windows/netexe-reference" name="scite-11" rel="nofollow" target="_blank">
    ...
    <li>
     <span class="scite-citation" id="scite-13">
      <span class="scite-citation-text">
       <a class="external text" href="https://docs.microsoft.com/windows/device-security/auditing/event-4720" name="scite-13" rel="nofollow" target="_blank">
